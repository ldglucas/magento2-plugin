 ...
 *
 */
class Interes extends AbstractModel
{
    /**
     * @var string
     */
    protected $_eventPrefix = 'decidir_interes';
     ...
     * @var string
     */
    protected $_eventObject = 'adminplanescuotas_interes';
    ...
    {
        $this->_init('Decidir\AdminPlanesCuotas\Model\ResourceModel\Interes');
    }
