...
class Edit extends  \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($rowId)
        {
            ...
            if (!$rowData->getPlanPagoId())
            {
                ...
                $this->_redirect('adminplanescuotas/planpago/admin');
                return false;
            }
        }
        else
        ...
        $title = $rowId ? __('Editar plan de pago ').$rowTitle : __('Crear plan de pago');
    ...
    {
        return $this->_authorization->isAllowed('Decidir_AdminPlanesCuotas::planPago_edit');
    }
